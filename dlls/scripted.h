...
#define SF_SCRIPT_CONDNOINTERRUPT 16 // Like SF_SCRIPT_NOINTERRUPT, but don't ignore scripted conditions
#define SF_SCRIPT_NOINTERRUPT 32
#define SF_SCRIPT_OVERRIDESTATE 64
#define SF_SCRIPT_NOSCRIPTMOVEMENT 128
#define SF_SCRIPT_NORESETENTITY 256

#define SCRIPT_BREAK_CONDITIONS (bits_COND_LIGHT_DAMAGE | bits_COND_HEAVY_DAMAGE | bits_COND_GET_DAMAGE)
#define SCRIPT_BREAK_CONDITIONS_DONT_IGNORE_DAMAGE (bits_COND_LIGHT_DAMAGE | bits_COND_HEAVY_DAMAGE)
